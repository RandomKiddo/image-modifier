...
class Modifier:
    ...
    def detect_edges(self, outputpath: str = 'detectedges.jpg', show: bool = False):
        ...
        if show:
            ...
            plot.subplot(122), plot.imshow(edges)
            plot.show()
        return Modifier(outputpath)
    ...
    def blur(self, outputpath: str = 'blur.jpg', show: bool = False):
        ...
        if show:
            plot.figure(figsize=(16, 16))
            plot.subplot(122), plot.imshow(blur)
            plot.show()
        return Modifier(outputpath)
    gaussian_blur = blur
    def sharpen(self, outputpath: str = 'sharpen.jpg', show: bool = False):
        ...
        if show:
            plot.figure(figsize=(16, 16))
            plot.subplot(122), plot.imshow(sharpen)
            plot.show()
        return Modifier(outputpath)
    def emboss(self, outputpath: str = 'emboss.jpg', show: bool = False):
        ...
        if show:
            plot.figure(figsize=(16, 16))
            plot.subplot(122), plot.imshow(emboss)
            plot.show()
        return Modifier(outputpath)

m = Modifier('test.jpg')
m.emboss('testemboss.jpg')